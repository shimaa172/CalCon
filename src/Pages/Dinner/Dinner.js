        ...
        >
          ...
          <div className={` d-flex flex-column mt-5 ${classes.Div2} `}>
            ...
            >
              ...
              <Cards className="" id="Sandwiches" arrayimg={dinnerMeals} />
              <Cards className="" id="dishes" arrayimg={dinnerMeals} />
              <Cards className="" id="Drinks" arrayimg={dinnerMeals} />
              <Cards className="" id="Desserts" arrayimg={dinnerMeals} />
              <Cards className="" id="snacks" arrayimg={dinnerMeals} />
            </div>
          </div>
